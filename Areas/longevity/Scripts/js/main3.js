...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function animateChart() {
        gsap.timeline()
            .to(normalArrow, { scale: 1, duration: 0.4, ease: 'back.out(1.7)' }, "+=0.05")
            .to(normalLabel, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(normalDesc, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(acceleratedArrow, { scale: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(acceleratedLabel, { opacity: 1, duration: 0.1, ease: 'back.out(1.7)' })
            .to(acceleratedDesc, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(normalArrow, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' }, "+=0.05")
            .to(normalLabel, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' })
            .to(normalDesc, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' })
            .to(mainDesc, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(superArrow, { scale: 1, duration: 0.4, ease: 'back.out(1.7)' }, "+=0.05")
            .to(superLabel, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(superDesc, { opacity: 1, duration: 0.4, ease: 'back.out(1.7)' })
            .to(acceleratedArrow, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' })
            .to(acceleratedLabel, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' })
            .to(acceleratedDesc, { opacity: .3, duration: 0.1, ease: 'back.out(1.7)' });
    }
